...
// Variables
const API_LINK = "https://raw.githubusercontent.com/AdarshKumar9002/conutry-city-detail/main/data.json";
let countryDropdownValue = "";
let cityDropdownValue = "";
// Fetching Data
const fetchData = async ()=>{
    let response = await (0, _axiosDefault.default).get(API_LINK);
...
COUNTRY_FORM_ELEMENT.addEventListener("submit", (event)=>{
    ...
    CITY_DROPDOWN_ELEMENT.insertAdjacentHTML("afterbegin", `<option> Select a City </option>`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire9554")
